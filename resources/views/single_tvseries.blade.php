...
<div class="container col-md-12" style="margin-top:7rem !important;">
    ...
    <div class="movie-container" style="background-image:url({{asset('prototype_images/corosel/breakingbad.jpg')}});">
        <div class="movie-details">
            <div class="movie-info">
                <h1 class="movie-title">BreakingBad</h1>
                <p class="movie-description">
                    Movie Overview
                </p>
                <div class="d-flex fs-5">

                    <p class="me-3">Violence,Action, Adeventure</p>
